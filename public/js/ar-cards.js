...
function initialize()
{
	...
	let markerControls1 = new THREEx.ArMarkerControls(arToolkitContext, markerRoot1, {
		type: 'pattern', patternUrl: "imgs/patts/Pattern_Test_2.patt",
	})


    const earth = createSphere('imgs/textures/earth_texture.jpg');
...
function createSphere(texture_img) {
    let geometry1 = new THREE.SphereGeometry(1, 32,32);
	
	let loader = new THREE.TextureLoader();
	let texture = loader.load( texture_img, render );
